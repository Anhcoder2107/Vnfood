                                    ...
                                    <tbody>
                                        <?php foreach ($orders as $order) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo APPURL . 'admin/order/detail?id=' . $order['order_id'] ?>" class="btn btn-primary">Detail</a>
                                                    <a href="<?php echo APPURL . 'admin/order/update?id=' . $order['order_id'] ?>" class="btn btn-warning">Update</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
