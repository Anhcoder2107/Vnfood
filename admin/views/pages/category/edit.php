                                ...
                                <form class="forms-sample" method="POST" action="">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputName1"
                                            placeholder="Name" name="category_name" value="<?php echo $category['category_name'] ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleTextarea1">Textarea</label>
                                        <textarea class="form-control" name="description" id="exampleTextarea1" rows="4"><?php echo $category['description'] ?></textarea>
                                    </div>
